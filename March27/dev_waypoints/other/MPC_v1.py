...
if obstacles_option == 4:
    
    global_end_goal_x       =    10     #position of initial and end point
    global_end_goal_y       =    0
    initial_pos_x           =    0
    initial_pos_y           =    0
...
#if you want end goal to stay the same alqays == global end goal
...
plt.figure(dpi=300)
plt.plot(x_hist[12,:],y_hist[12,:], 'bx--')
plt.plot(x_hist[13,:],y_hist[13,:], 'rx--')
# plt.plot(x_hist[3,:],y_hist[3,:], 'yx--')
# plt.plot(x_hist[4,:],y_hist[4,:], 'cx--')
plt.plot(global_path_x, global_path_y, 'g--')
