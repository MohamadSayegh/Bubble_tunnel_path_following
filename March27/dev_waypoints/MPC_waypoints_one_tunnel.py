...
update: constraint vilation at x0 is solved with providing bubbles prior to location.
here I am keeping all the bubbles for all the time = faster computation of mpc loop 


problem: locla min appearing with generate_bubbles_mpc_v3: why ?

"""


#----------- Set python path for functions 
...
from MPC_Bubble_tunnel_generation_functions import generate_bubbles_mpc_v3, generate_bubbles_mpc_v2
from MPC_helper_functions import create_obstacles_mpc, create_global_path_mpc, create_tunnel
...
ocp.add_objective( 10*ocp.integral((x - end_goal_x)**2 + (y-end_goal_y)**2))  
...
def animate(i):
    ...
    Bubbles1.set_data( tunnel_x , tunnel_y)
    ...
    return [Obs,Points,Path,Point1, Bubbles1] 
