...
static const casadi_int casadi_s10[6] = {0, 0, 0, 0, 0, 0};
...
static const casadi_int casadi_s15[7] = {6, 1, 0, 3, 0, 1, 4};
...
/* rockit_model_constr_h_e_fun_jac_uxt_zt:(i0[6],i1[],i2[],i3[12])->(o0,o1[6x1,3nz],o2[1x0]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  casadi_real **res1=res+3, *rr, *ss;
  const casadi_int *cii;
  const casadi_real **arg1=arg+4;
  casadi_real w0, w1, w2, *w3=w+105, w4, w5, *w6=w+113, *w7=w+119, w8, *w9=w+126;
  /* #0: @0 = input[0][0] */
  w0 = arg[0] ? arg[0][0] : 0;
  /* #1: @1 = input[0][4] */
  w1 = arg[0] ? arg[0][4] : 0;
  ...
  w2 = arg[3] ? arg[3][7] : 0;
  /* #3: @3 = @2[0, 0, 0, 0, 0, 0] */
  for (cii=casadi_s10, rr=w3, ss=(&w2); cii!=casadi_s10+6; ++cii) *rr++ = *cii>=0 ? ss[*cii] : 0;
  /* #4: @2 = x(@1, @3) */
  arg1[0]=(&w1);
  arg1[1]=w3;
  res1[0]=(&w2);
  ...
  w5 = arg[3] ? arg[3][8] : 0;
  /* #9: @6 = @5[0, 0, 0, 0, 0, 0] */
  for (cii=casadi_s10, rr=w6, ss=(&w5); cii!=casadi_s10+6; ++cii) *rr++ = *cii>=0 ? ss[*cii] : 0;
  /* #10: @5 = y(@1, @6) */
  arg1[0]=(&w1);
  arg1[1]=w6;
  res1[0]=(&w5);
  ...
  w5 = arg[3] ? arg[3][9] : 0;
  /* #15: @7 = @5[0, 0, 0, 0, 0, 0] */
  for (cii=casadi_s10, rr=w7, ss=(&w5); cii!=casadi_s10+6; ++cii) *rr++ = *cii>=0 ? ss[*cii] : 0;
  /* #16: @5 = r(@1, @7) */
  arg1[0]=(&w1);
  arg1[1]=w7;
  res1[0]=(&w5);
