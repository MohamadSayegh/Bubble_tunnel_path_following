...
#     initial_pos_x = x_sol[0]
#     initial_pos_y = y_sol[0]
    
    
#     #------------------------- Generate grid and path -------------------------

#     global_path_x, global_path_y , Bspline_obj = \
#         create_global_path_mpc(path_option,initial_pos_x,initial_pos_y)
    
#     #------------------------- goal point based on end point of path ----------
    
#     end_goal_x = global_path_x
#     end_goal_y = global_path_y
...
#         create_obstacles_mpc(obstacles_option, initial_pos_x, initial_pos_y)
...
#             generate_bubbles_v2(global_path_x,global_path_y,occupied_positions_x,occupied_positions_y)
