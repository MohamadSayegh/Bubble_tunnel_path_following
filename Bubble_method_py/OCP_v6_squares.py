...
ocp.subject_to( (  (  x - obs_spline_x(s1) )**2    <  (tolerance + obs_spline_r(s1)**2)    ))
ocp.subject_to( (  (  y - obs_spline_y(s1) )**2    <  (tolerance + obs_spline_r(s1)**2)    ))

# ocp.subject_to(  - (tolerance + obs_spline_r(s1))   <   ( x - obs_spline_x(s1)     <  (tolerance + obs_spline_r(s1))   ) )   
# ocp.subject_to(  - (tolerance  + obs_spline_r(s1))   <   ( y - obs_spline_y(s1)    <  (tolerance + obs_spline_r(s1))    ) )  

# ------------- Objective function ----------------------------------------

#path following
ocp.add_objective(10*ocp.integral((x - path_spline_x(s2))**2 + (y-path_spline_y(s2))**2))  
